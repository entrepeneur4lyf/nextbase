...
import (
	...
	"github.com/nextbase/nextbase/tools/search"
...
func recordsList(e *core.RequestEvent) error {
	...
	return e.App.OnRecordsListRequest().Trigger(event, func(e *core.RecordsListRequestEvent) error {
		...
		//
		// In all cases it doesn't really matter that much because it doesn't affect the builtin nextbase security sensitive fields (e.g. password and tokenKey) since they
