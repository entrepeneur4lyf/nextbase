...
// WrapStdHandler wraps Go [http.Handler] into a nextbase handler func.
...
// WrapStdMiddleware wraps Go [func(http.Handler) http.Handle] into a nextbase middleware func.
