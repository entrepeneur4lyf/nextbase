...
import (
	...
	"github.com/entrepeneur4lyf/nextbase/plugins/jsvm"
...
func main() {
	...
	gen := tygoja.New(tygoja.Config{
		Packages: map[string][]string{
			...
			"github.com/entrepeneur4lyf/nextbase/tools/template":   {"*"},
			"github.com/entrepeneur4lyf/nextbase/mails":            {"*"},
			"github.com/entrepeneur4lyf/nextbase/apis":             {"*"},
			"github.com/entrepeneur4lyf/nextbase/core":             {"*"},
			"github.com/entrepeneur4lyf/nextbase/forms":            {"*"},
			"github.com/entrepeneur4lyf/nextbase":                  {"*"},
			"path/filepath":                                        {"*"},
			"os":                                                   {"*"},
			"os/exec":                                              {"Command"},
		},
