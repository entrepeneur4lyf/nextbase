...
import (
	...
	"github.com/nextbase/nextbase/tools/cron"
	"github.com/nextbase/nextbase/tools/filesystem"
	"github.com/nextbase/nextbase/tools/hook"
	"github.com/nextbase/nextbase/tools/logger"
	"github.com/nextbase/nextbase/tools/mailer"
	"github.com/nextbase/nextbase/tools/routine"
	"github.com/nextbase/nextbase/tools/store"
	"github.com/nextbase/nextbase/tools/subscriptions"
	"github.com/nextbase/nextbase/tools/types"
...
// BaseApp implements core.App and defines the base nextbase app structure.
type BaseApp struct {
...
func (app *BaseApp) initAuxDB() error {
	...
	// (see https://github.com/nextbase/nextbase/issues/5607)
	...
	app.OnModelAfterDeleteSuccess().Bind(&hook.Handler[*ModelEvent]{
		...
		Func: func(e *ModelEvent) error {
			if m, ok := e.Model.(FilesManager); ok && m.BaseFilesPath() != "" {
				...
				// (https://github.com/nextbase/nextbase/discussions/5246#discussioncomment-10128955)
